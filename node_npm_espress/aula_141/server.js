...
// Instanciar o store da sessão corretamente
const sessionStore = new MongoStore({
    mongoUrl: process.env.CONNECTIONSTRING,
    collectionName: 'sessions' // opcional, mas bom para nomear a coleção
});
...
const sessionOptions = session({
    secret: 'testeste', 
    store: sessionStore, // Aqui usamos a instância do MongoStore
    resave: false,
